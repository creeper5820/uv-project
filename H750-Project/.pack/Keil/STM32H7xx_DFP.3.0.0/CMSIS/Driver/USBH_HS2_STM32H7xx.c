 ...
 *
 * Notes:
 *   - provide USBH1_VbusOnOff function to use custom VBUS driving
 *   - provide USBH1_GetOC function to use custom over-current status detection
 * -------------------------------------------------------------------------- */
...
/*! \page stm32h7_usbh1 CMSIS-Driver USBH_HS2 Setup
...
-----------------
  1. Under Connectivity open \b USB_FS Configuration:
     ...
     - <b>NVIC Settings</b>: disable interrupts
          ...
          :-------------------------------------------------|:--------|:--------------------|:--------------
          USB On The Go FS End Point 1 Out global interrupt |\b OFF   | 0                   | 0
          USB On The Go FS End Point 1 In global interrupt  |\b OFF   | 0                   | 0
          USB On The Go FS global interrupt                 |\b OFF   | 0                   | 0
...
#if    (OTG_FS_USED == 1)               // If OTG_FS is enabled in CubeMX
