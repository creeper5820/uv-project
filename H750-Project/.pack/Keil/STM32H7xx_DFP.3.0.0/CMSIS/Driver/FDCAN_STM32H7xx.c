 ...
 * Project:      CMSIS CAN1/2 Driver for FDCAN 1/2 of ST STM32H7xx
 * --------------------------------------------------------------------------
 ...
 *   ---------------------                 -----   -------------
 *   Connect to hardware via Driver_CAN# = 1       use FDCAN1
 *   Connect to hardware via Driver_CAN# = 2       use FDCAN2
 * --------------------------------------------------------------------------
...
/*! \page stm32h7_can CMSIS-Driver CAN Setup
...
----------
  1. Configure FDCAN1 mode
     - Peripheral \b FDCAN1: Mode=<b>Master Mode</b>
  2. Configure FDCAN1 pins (not the default pins):
     - Click in chip diagram on pin \b PA11 and select \b FDCAN1_RX
     - Click in chip diagram on pin \b PA12 and select \b FDCAN1_TX
...
Configuration tab
-----------------
  1. Under Connectivity open \b FDCAN1 Configuration:
     - Parameter Settings: not used
     - User Constants: not used
     - <b>NVIC Settings</b>: disable interrupts
          Interrupt Table    | Enabled | Preemption Priority | Sub Priority
          :------------------|:--------|:--------------------|:--------------
          FDCAN1 interrupt 0 |\b OFF   | 0                   | 0
          FDCAN1 interrupt 1 |\b OFF   | 0                   | 0
     ...
     - Click \b OK to close the FDCAN1 Configuration dialog
*/
