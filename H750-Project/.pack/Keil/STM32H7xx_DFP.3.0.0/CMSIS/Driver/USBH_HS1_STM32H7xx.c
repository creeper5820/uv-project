 ...
 *
 * Notes:
 *   - provide USBH0_VbusOnOff function to use custom VBUS driving
 *   - provide USBH0_GetOC function to use custom over-current status detection
 * -------------------------------------------------------------------------- */
...
/*! \page stm32h7_usbh0 CMSIS-Driver USBH_HS1 Setup
...
----------
  1. Configure USBH mode
     - Peripherals \b USB_OTG_HS: External Phy=<b>Host_Only</b>
  2. Configure USB_OTG_HS_ULPI_NXT pin (is not the default pin):
     - Click in chip diagram on pin \b PH4 and select \b USB_OTG_HS_ULPI_NXT
...
Configuration tab
-----------------
  1. Under Connectivity open \b USB_HS Configuration:
     - Parameter Settings: not used
     - User Constants: not used
     - <b>NVIC Settings</b>: disable interrupts
          Interrupt Table                                   | Enabled | Preemption Priority | Sub Priority
          :-------------------------------------------------|:--------|:--------------------|:--------------
          USB On The Go HS End Point 1 Out global interrupt |\b OFF   | 0                   | 0
          USB On The Go HS End Point 1 In global interrupt  |\b OFF   | 0                   | 0
          USB On The Go HS global interrupt                 |\b OFF   | 0                   | 0
...
#if    (OTG_HS_USED == 1)               // If OTG_HS is enabled in CubeMX
